<?php
    ...
    $insertMovie = $peliculesdb -> insertOne(['titol' => $titol, 'director' => $nomDirector, 'durada' => $duradaPelicula, 'pegi' => $PEGI, 'valoracio' => $valoracioPelicula, 'any' => $anyPelicula, 'descripcio' => $descripcioPelicula, 'imatge' => $imatgePelicula, 'copies' => 1]);
